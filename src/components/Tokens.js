          ...
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto">
                <h1 style={{ color: '#fff' }}>Gestión de los Tokens ERC-20</h1>
                &nbsp;
                <Container>
                  <Row>
                    <Col>
                      <h3 style={{ color: '#fff' }}>Tokens User</h3>
                      <form onSubmit={(event) => {
                    ...
                    <Col>
                      <h3 style={{ color: '#fff' }}>Tokens SC</h3>
                      <form onSubmit={(event) => {
                        event.preventDefault()
                    ...
                    <Col>
                      <h3 style={{ color: '#fff' }}>Ethers SC</h3>
                      <form onSubmit={(event) => {
                        event.preventDefault()
                ...
                &nbsp;
                <h3 style={{ color: '#fff' }}>Compra de Tokens ERC-20</h3>
                <form onSubmit={(event) => {
                  event.preventDefault()
                ...
                <h3 style={{ color: '#fff' }}>Devolución de tokens ERC-20</h3>
